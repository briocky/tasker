...
public interface TasksCategoryMapper {
  ...
  @Mapping(target = "membersEmails", expression = "java(source.getMembers().stream().map(pl.dobos.tasker.models.entities.User::getEmail).collect(java.util.stream.Collectors.toList()))")
